                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="card card-primary">
                                                ...
                                                <form action="{{route('uabjo_materias.store', $id_uabjo_carrera)}}" method="post">
                                                    <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nombre" class="form-control" id="nombre" placeholder="Ingrese nombre" value="{{ old('nombre') }}" required minlength="1" maxlength="255" pattern="([a-záéíóúüñA-ZÁÉÍÓÚÜÑ]+)(\s[a-záéíóúüñA-ZÁÉÍÓÚÜÑ]+)*" title="Materia Escuela de Ciencias">
