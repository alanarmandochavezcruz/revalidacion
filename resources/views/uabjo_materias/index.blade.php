...
@can('create_uabjo_materias')
    <a href="{{route('uabjo_materias.create', $id_uabjo_carrera)}}" class="btn btn-primary">
...
<table id="example1" class="table table-bordered table-striped">
    <thead>
        <tr>
            <th>Materias (Escuela de Ciencias)</th>
            <th></th>
        </tr>
    </thead>
    <tbody>
                                @include('uabjo_materias.registros')
