...
@section('content')
    ...
    @if(count($dictamen_registros) < 1)
        @can('create_dictamen')
            <a href="{{route('predictamen.create', $id_alumno)}}" class="btn btn-primary">
	...
	<table id="example1" class="table table-bordered table-striped">
		<thead>
			<tr>
                <th>Clave</th>
                <th>Periodo</th>
		        <th>Director <br> Escuela de Ciencias</th>
		        <th>Coordinador <br> Escuela de Ciencias</th>
		        <th>Director <br> Servicios Escolares</th>
		        <th>Sub Director <br> Servicios Escolares</th>
                <th>Secretaria <br> Servicios Escolares</th>
		        <th>Estado</th>
		        <th></th>
			</tr>
		</thead>
		<tbody>
			@include('dictamen_registros.registros')
		</tbody>
        <tfoot>
            <tr>
                <th>Clave</th>
