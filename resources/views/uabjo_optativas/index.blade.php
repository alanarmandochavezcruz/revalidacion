...
<p>
    <a href="{{route('uabjo_carreras.index')}}" class="btn btn-success">
        <i class="fas fa-arrow-left"></i>
    </a>

@can('create_uabjo_optativas')
    <a href="{{route('uabjo_optativas.create', $id_uabjo_carrera)}}" class="btn btn-primary">
...
<table id="example1" class="table table-bordered table-striped">
    <thead>
        <tr>
            <th>Optativas (Escuela de Ciencias)</th>
            <th></th>
        </tr>
    </thead>
    <tbody>
                                @include('uabjo_optativas.registros')
